...
AccuracyCutoffInfo <- function( train.probability, trian.truth, test.probability, test.truth)
{
    ...
    accuracy <- lapply( cutoff, function(c)
    {
        ...
        train.predicted <- ifelse(train.probability > c,"Y","N")
        test.predicted <- ifelse(test.probability > c,"Y","N")
        cm_train <- confusionMatrix(table(train.predicted, train.truth))
        cm_test  <- confusionMatrix(table(test.predicted, test.truth))
